...
/** @param {{stage: string, model?: string, geometryResolution?: string, textureResolution?: string}} p */
export function priceOf({ stage, model = 't2', geometryResolution = 'standard', textureResolution = '2k' }) {
	switch (stage) {
		case 'preview': {
